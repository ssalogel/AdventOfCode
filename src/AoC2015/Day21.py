...
class Day21(Day):
    def __init__(self, content=None):
        ...
        self.armor: list[tuple[int, int, int]] = [
            (0, 0, 0),
            (13, 0, 1),
            (31, 0, 2),
            (53, 0, 3),
        ...
        self.rings: list[tuple[int, int, int]] = [
            (0, 0, 0),
            (0, 0, 0),
            (25, 1, 0),
            (50, 2, 0),
    ...
    def get_equipment_combo(self):
        combos = [
            tuple(map(sum, zip(*p)))
            for p in product(self.weapons, self.armor, self.rings, self.rings)
        ]
        combos.sort()
        return combos
