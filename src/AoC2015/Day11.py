...
class Day11(Day):
    ...
    def no_forbidden(num_pass: list[int]) -> bool:
        return (
            ord("i") not in num_pass
            and ord("o") not in num_pass
            and ord("l") not in num_pass
        )
    ...
    def is_valid(cls, num_pass: list[int]) -> bool:
        return (
            cls.no_forbidden(num_pass)
            and cls.has_double(num_pass)
            and cls.has_three_sequence(num_pass)
        )
